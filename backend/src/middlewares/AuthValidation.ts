...
export default class AuthValidator {
  static async validateCreateInput(
    req: Request,
    res: Response,
    next: NextFunction
  ) {
  ...
  static async validateLoginInput(
    req: Request,
    res: Response,
    next: NextFunction
  ) {
  ...
  static async validateUpdatePassword(
    req: Request,
    res: Response,
    next: NextFunction
  ) {
  ...
  static async update(req: Request, res: Response, next: NextFunction) {
    ...
    await body("email").isEmail().withMessage("Email is not valid").optional().run(req);
